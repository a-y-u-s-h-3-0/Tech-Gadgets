    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="d-flex justify-content-end mb-3">
                ...
                <a href="{{ route('store.create') }}" class="btn-add">
                    <span>Add</span>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="img-container">
                                        <img height="50" width="50" src="/images/{{ $item->store_pic }}"
                                            alt="">
                                    </div>
                                </td>

                                <td>{{ $item->store_mobileno }}</td>
                                <td>{{ $item->store_address }}</td>
                                <td>{{ $item->store_pincode }}</td>
                                <td>{{ $item->latitude }}</td>
                                ...
                                <td>
                                    <div class="d-flex justify-content-center align-items-end">
                                        <a href="{{ route('store.edit', $item->_id) }}" class="btn-edit"
                                            style="margin-right: 10px;"><span>Edit</span>
                                            <i class="fas fa-edit"></i>
                                        </a>

                                        <form onsubmit="confirmDelete(event)" class="d-inline"
                                            action="{{ route('store.destroy', $item->_id) }}" method="POST">
                                            @csrf
                                            @method('delete')
