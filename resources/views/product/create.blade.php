            ...
            <div class="card-body p-4">
                <form action="{{ route('product.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3 input-group">
                        <input type="text" name="p_name" id="p_name" class="input" placeholder=" " value="{{ old('p_name') }}">
                    ...
                    <div class="mb-3 input-group">
                        <input type="number" name="p_price" id="p_price" class="input" placeholder=" " value="{{ old('p_price') }}">
                    ...
                    <div class="mb-3 input-group">
                        <input type="text" name="p_desc" id="p_desc" class="input" placeholder=" " value="{{ old('p_desc') }}">
                    ...
                    <div class="mb-3 input-group">
                        <input type="number" name="p_discount" id="p_discount" class="input" placeholder=" " value="{{ old('p_discount') }}">
                    ...
                    <div class="mb-3 input-group">
                        <input type="text" name="p_size" id="p_size" class="input" placeholder=" " value="{{ old('p_size') }}">
                    ...
                    <div class="mb-3 input-group">
                        <input type="text" name="working_time" id="working_time" class="input" placeholder=" " value="{{ old('working_time') }}">
                    ...
                    <div class="mb-3 input-group">
                        <input type="text" name="p_country" id="p_country" class="input" placeholder=" "value="{{ old('p_country') }}">
                    ...
                    <div class="mb-3 input-group">
                        <input type="text" name="p_warranty" id="p_warranty" class="input" placeholder=" "value="{{ old('p_warranty') }}">
                    ...
                    <div class="mb-3 input-group">
                        <input type="file" name="p_pic2" id="p_pic2" class="custom-file-input" accept="image/*">
                    ...
                    <div class="d-grid">
                        <button type="submit" class="btn-primary mt-4">Add Products</button>
                    </div>
                </form>
            </div>
        </div>
