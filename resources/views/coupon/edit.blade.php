            ...
            <div class="card-body p-4">
                <form action="{{ route('coupon.update', $coupon->_id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3 input-group">
                        <input type="text" name="c_code" id="c_code" class="input"  value="{{$coupon->c_code}}" placeholder=" ">
                    ...
                    <div class="mb-3 input-group">
                        <input type="text" name="c_desc" id="c_desc" class="input" value="{{$coupon->c_desc}}" placeholder=" ">
                    ...
                    <div class="mb-3 input-group">
                        <input type="number" name="c_discount" id="c_discount" class="input" value="{{$coupon->c_discount}}" placeholder=" ">
                    ...
                    <div class="mb-3 input-group">
                        <input type="text" name="c_max_amt" id="c_max_amt" class="input"value="{{$coupon->c_max_amt}}" placeholder=" ">
                    ...
                    <div class="d-grid">
                        <button type="submit" class="btn-primary mt-4">Update Coupon</button>
                    </div>
                </form>
