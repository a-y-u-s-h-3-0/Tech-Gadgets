    ...
    <div class="card">
        ...
        <div class="card-body ">
            <div class="d-flex justify-content-end mb-3">
                <a href="{{ route('coupon.create') }}" class="btn-add"> <span>Add</span>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex justify-content-center align-items-end">
                                    ...
                                    <a href="{{ route('coupon.show', $item->_id) }}" class="btn-show"><span>Show</span>
                                        <i class="fa-solid fa-eye-slash"></i></a>

                                    <a href="{{ route('coupon.edit', $item->_id) }}" class="btn-edit"
                                        style="margin-right: 10px;"><span>Edit</span>
                                        <i class="fas fa-edit"></i>
                                    </a>

                                    <form onsubmit="confirmDelete(event)" class="d-inline"
                                        action="{{ route('coupon.destroy', $item->_id) }}" method="POST">
                                        @csrf
                                        @method('delete')
