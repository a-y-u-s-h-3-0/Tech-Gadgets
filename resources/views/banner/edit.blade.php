            ...
            <div class="card-body p-4">
                <form action="{{ route('banner.update', $banner->_id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3 input-group">
                        <input type="text" name="banner_name" id="banner_name" class="input" value="{{$banner->banner_name}}" placeholder=" ">
                    ...
                    <div class="mb-3 input-group">
                        <input type="file" name="banner_pic" id="banner_pic" value="{{$banner->banner_pic}}" class="custom-file-input" accept="image/*">
                    ...
                    <div class="d-grid">
                        <button type="submit" class="btn-primary mt-4">Update Banner</button>
                    </div>
                </form>
