            ...
            <div class="card-body p-4">
                <form action="{{ route('blog.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="input-group">
                        <input type="text" name="b_title" id="b_title" class="input" placeholder="" value="{{ old('b_title') }}">
                    ...
                    <div class="input-group">
                        <input type="text" name="b_desc" id="b_desc" class="input" placeholder="" value="{{ old('b_desc') }}">
                    ...
                    <div class="input-group">
                        <input type="date" name="b_date" id="b_date" class="input" placeholder="" value="{{ old('b_date') }}">
                    ...
                    <div class="input-group">
                        <input type="time" name="b_time" id="b_time" class="input" placeholder="" value="{{ old('b_time') }}">
                    ...
                    <div class="input-group">
                        ...
                        <div class="d-grid">
                            <button type="submit" class="btn-primary mt-4">Add Blog</button>
                        </div>
