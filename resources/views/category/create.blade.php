            ...
            <div class="card-body p-4">
                <form action="{{ route('category.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3 input-group">
                        <input type="text" name="cat_name" id="cat_name" class="input" placeholder=" " value="{{ old('cat_name') }}">
                    ...
                    <!-- Custom File Input -->
                    <div class="mb-3 input-group">
                        <input type="file" name="cat_pic" id="cat_pic" class="custom-file-input" accept="image/*" value="{{ old('cat_pic') }}">
                    ...
                    <div class="d-grid">
                        <button type="submit" class="btn-primary mt-4">Add Category</button>
                    </div>
                </form>
            </div>
        </div>
